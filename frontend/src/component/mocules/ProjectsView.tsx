    ...
    <>
            ...
            {projects.map((project) => (
              <TableRow key={project.id}>
                ...
                <TableCell align="right">
                  ...
                  <IconButton onClick={() => handleDuplicate(project)} title="Duplicate as new">
                    <ContentCopyIcon />
                  </IconButton>
      ...
      <Dialog open={isModalOpen} onClose={handleCloseModal}>
        ...
        <DialogContent>
          ...
          {/* Code is system-generated by backend; no inputs shown */}
          ...
          <TextField margin="dense" name="client_address" label="Client Address" type="text" fullWidth variant="outlined" value={(formData as any).client_address || ''} onChange={handleFormChange} />
          <TextField margin="dense" name="project_description" label="Project Description" type="text" fullWidth multiline minRows={2} variant="outlined" value={(formData as any).project_description || ''} onChange={handleFormChange} />
          <FormControlLabel
            control={
